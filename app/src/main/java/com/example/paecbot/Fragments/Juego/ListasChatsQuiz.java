...
public class ListasChatsQuiz extends Fragment {
    ...
    private void setUpViewPager(ViewPager viewPager)
    {
        ...
        fragmentmanager.addFragment(new ListaChats(),"Chats");
        fragmentmanager.addFragment(new ListaQuiz(),"Quizzes");
